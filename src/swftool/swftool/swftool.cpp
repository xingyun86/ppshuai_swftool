// swftool.cpp : main source file for swftool.exe
//
...
//		run nmake -f swftoolps.mk in the project directory.
#include "initguid.h"
#include "swftool.h"
#include "swftool_i.c"
...
//	HRESULT hRes = ::CoInitializeEx(NULL, COINIT_MULTITHREADED);
	...
	while(lpszToken != NULL)
	{
		...
		{
			_Module.UpdateRegistryFromResource(IDR_SWFTOOL, FALSE);
		...
		{
			_Module.UpdateRegistryFromResource(IDR_SWFTOOL, TRUE);
